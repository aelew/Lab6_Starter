...
class RecipeCard extends HTMLElement {
  ...
  constructor() {
    ...
    const articleEl = document.createElement('article'); // A2
    const styleEl = document.createElement('style'); // A3
    styleEl.textContent = STYLES; // A4
  ...
  set data(data) {
    ...
    const articleEl = this.shadowRoot.querySelector('article'); // A6
